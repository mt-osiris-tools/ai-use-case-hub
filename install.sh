...
if [[ ":$PATH:" != *":$HOME/.local/bin:"* ]]; then
    ...
    if [[ "$add_to_path" =~ ^[Yy]$ ]]; then
        if [ -f "$HOME/.bashrc" ]; then
            ...
            echo "Run: ${CYAN}source ~/.bashrc${NC} to apply"
        else
...
echo "  1. Reload your shell: ${CYAN}source ~/.bashrc${NC}"
echo "  2. Navigate to a project: ${CYAN}cd /path/to/your-project${NC}"
echo "  3. Setup the project: ${CYAN}ai-use-case --init${NC}"
echo "  4. Document AI sessions: ${CYAN}ai-use-case document${NC}"
echo ""
echo -e "${YELLOW}Available Commands:${NC}"
echo "  ${GREEN}ai-use-case --init${NC}       Setup current project"
echo "  ${GREEN}ai-use-case document${NC}     Document an AI session"
echo "  ${GREEN}ai-use-case sync${NC}         Sync use cases to hub"
echo "  ${GREEN}ai-use-case search <term>${NC} Search use cases"
echo "  ${GREEN}ai-use-case stats${NC}        View statistics"
echo "  ${GREEN}ai-use-case --help${NC}       Show all commands"
echo ""
echo -e "${YELLOW}Next Steps:${NC}"
echo "  Run ${CYAN}ai-use-case --help${NC} for full usage guide"
echo "  Read ${CYAN}$INSTALL_DIR/README.md${NC} for detailed documentation"
echo ""
